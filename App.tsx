...
import FinanceAccountingCoursePage from './pages/FinanceAccountingCoursePage';
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/courses/agentic-ai-finance-accounting" element={<FinanceAccountingCoursePage />} />
