            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-7">
                ...
                <div className="flex flex-wrap gap-4 mb-8">
                  ...
                  <a
                    href="https://wa.me/6596615284?text=Hi%20Cariah%2C%20I%27m%20from%20an%20accounting%20or%20CSP%20team%20and%20want%20to%20enquire%20about%20team%20training."
                    target="_blank"
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-primary rounded-3xl p-8 lg:p-12 text-white text-center shadow-2xl">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <a
                  href="https://wa.me/6596615284?text=Hi%20Cariah%2C%20I%27m%20from%20an%20accounting%20or%20CSP%20team%20and%20want%20to%20enquire%20about%20a%20private%20cohort."
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() =>
                    trackOutboundClick({
