    ...
    <div className="min-h-screen bg-neutral font-sans text-textDark pb-24">
      ...
      <main>
        ...
        <section className="bg-neutral">
              <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8" aria-labelledby="foundation-advanced-fit">
        ...
        <section className="bg-white py-14">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="rounded-2xl border border-blue-100 bg-blue-50 p-7 sm:p-9">
              ...
              >
                Compare AI courses in Singapore and SkillsFuture support →
              </Link>
            </div>
          </div>
        </section>
