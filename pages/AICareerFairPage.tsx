  ...
  return <div className="min-h-screen bg-[#f7f8fc] text-gray-800">
    ...
    <main>
      <section className="relative overflow-hidden bg-[#001827] pt-28 text-white lg:pt-0">
        ...
        <img src="/images/career/ai-career-readiness-hero.jpg" alt="Three early-career professionals walking towards connected Tech and Accountancy opportunities" width="1280" height="720" loading="eager" className="relative z-0 block h-auto w-full lg:absolute lg:inset-0 lg:h-full lg:object-cover" />
      </section>
