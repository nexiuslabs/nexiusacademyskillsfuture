...
const AICareerFairPage: React.FC = () => {
  ...
  return <div className="min-h-screen bg-[#f7f8fc] text-gray-800">
    ...
    <Navbar />
    <main>
      <section className="relative overflow-hidden bg-gradient-to-br from-primary via-[#3b287a] to-[#0d6f70] pt-32 pb-20 text-white">
        <div className="container-page"><p className="mb-5 text-xs font-bold tracking-[.18em] text-teal-200">TECH &amp; ACCOUNTANCY CAREER FAIR 2026 · AI CAREER READINESS ACTION KIT</p><h1 className="max-w-4xl text-balance text-4xl font-black leading-[1.05] md:text-6xl">AI changes tasks before it changes job titles.</h1><p className="mt-6 max-w-3xl text-lg leading-8 text-purple-50">Understand the shift, assess your work and build a practical 30/60/90-day plan for Tech or Accountancy.</p><div className="mt-8 flex flex-col gap-3 sm:flex-row"><a href="#action-kit" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-lg bg-accent px-6 py-3 font-bold text-white shadow-lg hover:bg-accent/90">Complete the check and build my kit <ArrowRight size={18}/></a><a href="#self-check" className="inline-flex min-h-12 items-center justify-center rounded-lg border border-white/50 px-6 py-3 font-bold hover:bg-white/10">Check my AI readiness</a></div><p className="mt-5 text-sm text-purple-100">Your personalised 8-page PDF is generated privately in your browser. No coding required.</p></div>
      </section>
