...
const routes = [
    ...
    schemas: [
      courseSchema({
        ...
        courseInstance: [
          ...
          {
            '@type': 'CourseInstance',
            name: '15 & 18 December 2026 Foundation cohort',
            description: 'Registration of interest only. Session times and venue to be confirmed.',
            courseMode: 'In-person',
    ...
    schemas: [
      courseSchema({
        ...
        offers: [
          {
            '@type': 'Offer',
            name: 'Singapore Citizen aged 40 and above or eligible SME-sponsored fee after subsidy',
            url: `${SITE_URL}/courses/advanced-agentic-ai/`,
            price: '190.50',
            priceCurrency: 'SGD',
            availability: 'https://schema.org/InStock',
        ...
        courseInstance: [
          {
            ...
            courseMode: 'In-person',
            courseWorkload: 'P3D',
            startDate: '2026-10-07T09:00:00+08:00',
            ...
            location: {
              ...
              address: {
                '@type': 'PostalAddress',
                streetAddress: '60 Cecil Street, Level 4, Room 4-2',
                addressLocality: 'Singapore',
                postalCode: '049709',
                addressCountry: 'SG',
              },
  ...
  },
  {
    ...
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    'url': 'https://academy.nexiuslabs.com/blog/',
    'name': 'AI Training Blog | Agentic AI Guides | Nexius Academy',
    'description': 'Agentic AI insights, practical business automation guides, and AI training analysis for Singapore professionals.',
    'itemListElement': [
    {
      '@type': 'ListItem',
      'position': 1,
      'url': '/blog/beyond-chatgpt-ai-powered-company/',
      'name': 'Beyond ChatGPT: Building an AI-Powered Company',
    },
    {
      '@type': 'ListItem',
      'position': 2,
      'url': '/blog/enterprise-ai-insights/',
      'name': 'Enterprise AI Insights: Scaling AI in 2026',
    },
    {
      '@type': 'ListItem',
      'position': 3,
      'url': '/blog/anthropic-ai-skills/',
      'name': 'Anthropic AI Skills for Business Professionals',
    },
    {
      '@type': 'ListItem',
      'position': 4,
      'url': '/blog/what-is-agentic-ai-guide/',
      'name': 'What Is Agentic AI? A Business Guide',
    },
    {
      '@type': 'ListItem',
      'position': 5,
      'url': '/blog/best-ai-courses-singapore-2026/',
      'name': 'Best AI Courses Singapore 2026: How to Choose',
    },
    {
      '@type': 'ListItem',
      'position': 6,
      'url': '/blog/smes-no-code-ai-automation-singapore/',
      'name': 'No-Code AI Automation for Singapore SMEs',
    },
    {
      '@type': 'ListItem',
      'position': 7,
      'url': '/blog/ai-literacy-corporate-learning-2026/',
      'name': 'AI Literacy for Corporate Learning in 2026',
    },
    {
      '@type': 'ListItem',
      'position': 8,
      'url': '/blog/ai-readiness-singapore-2026-agentic-ai/',
      'name': 'AI Readiness Singapore 2026: Pre-Build Checklist',
    },
    {
      '@type': 'ListItem',
      'position': 9,
      'url': '/blog/best-ai-for-coding-business-professionals/',
      'name': 'Best AI for Coding? What Business Teams Should Learn',
    },
    {
      '@type': 'ListItem',
      'position': 10,
      'url': '/blog/computer-using-agents-business-professionals/',
      'name': 'Computer-Using Agents for Business Professionals',
    },
    {
      '@type': 'ListItem',
      'position': 11,
      'url': '/blog/always-on-agents-work-iq-business-professionals/',
      'name': 'Always-On AI Agents: What Business Professionals Must Learn',
    },
    {
      '@type': 'ListItem',
      'position': 12,
      'url': '/blog/dashboard-agents-business-professionals/',
      'name': 'Dashboard Agents: What Business Professionals Must Learn',
    },
    {
      '@type': 'ListItem',
      'position': 13,
      'url': '/blog/ai-connectors-mcp-business-professionals/',
      'name': 'AI Connectors and MCP: What Business Professionals Must Learn',
    },
    {
      '@type': 'ListItem',
      'position': 14,
      'url': '/blog/agent-handoffs-business-professionals/',
      'name': 'Agent Handoffs: What Business Professionals Must Learn',
    },
    {
      '@type': 'ListItem',
      'position': 15,
      'url': '/blog/research-agents-business-professionals/',
      'name': 'Research Agents: What Business Professionals Must Learn',
    },
    {
      '@type': 'ListItem',
      'position': 16,
