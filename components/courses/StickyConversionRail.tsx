      ...
      {desktopVisible && (
        <aside className="hidden lg:block fixed right-4 top-1/2 -translate-y-1/2 z-40">
          <div className="bg-white border border-gray-200 shadow-xl rounded-xl p-3 w-56 space-y-2 relative">
            ...
            <a
              href="https://wa.me/6596615284?text=Hi%20Cariah%2C%20I%20want%20to%20check%20my%20subsidy%20and%20course%20fit."
              target="_blank"
            ...
            <button
              type="button"
              onClick={() =>
                openRegisterInterestModal('course_sticky', {
                  page: '/courses/agentic-ai',
                  position: 'course_sticky_desktop_register_interest',
                })
              }
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          <button
            ...
            onClick={() =>
              openRegisterInterestModal('course_sticky', {
                page: '/courses/agentic-ai',
                position: 'course_sticky_mobile_register_interest',
              })
            }
